...
![Топ-15 регионов по сбросу загрязненных сточных вод](visualizations/01_top_regions_discharge.png)
...
![Изменение объёма загрязняющих веществ за 30 лет](visualizations/05_pollutants_change.png)

*На диаграмме видно, что нитраты — единственный загрязнитель, ушедший в плюс. Все остальные сократились, причём некоторые — почти до нуля. Интерактивная версия: [Datawrapper](https://datawrapper.dwcdn.net/Fo3QM/1/)*
...
![Динамика загрязняющих веществ, 1993 = 100%](visualizations/08_pollutants_dynamics.png)
...
![Динамика сброса сточных вод, 1993–2022](visualizations/03_discharge_dynamics.png)
...
![Сравнение по федеральным округам](visualizations/04_districts_comparison.png)
...
![Карта загрязнения поверхностных вод](visualizations/07_map_pollution.png)
...
![Доли отраслей в загрязнении](visualizations/02_industry_shares.png)
